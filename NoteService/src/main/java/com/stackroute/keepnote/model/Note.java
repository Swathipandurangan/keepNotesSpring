...
public class Note {
	...
	public Note(int noteId, String noteTitle, String noteContent, String noteStatus, Category category,
			List<Reminder> reminders, String noteCreatedBy, Date noteCreationDate) {
		super();
		this.noteId = noteId;
		this.noteTitle = noteTitle;
		this.noteContent = noteContent;
	...
	public String toString() {
		return "Note [noteId=" + noteId + ", noteTitle=" + noteTitle + ", noteContent=" + noteContent + ", noteStatus="
				+ noteStatus + ", category=" + category + ", reminders=" + reminders + ", noteCreatedBy="
				+ noteCreatedBy + ", noteCreationDate=" + noteCreationDate + "]";
	}
